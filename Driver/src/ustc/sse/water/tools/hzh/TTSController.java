 ...
 */
/*
 * public void playText(String playText) { if (!isfinish) { return; } if (null
 * == mSpeechSynthesizer) { // 创建合成对象. mSpeechSynthesizer =
 * SpeechSynthesizer.createSynthesizer(mContext); initSpeechSynthesizer(); } //
 * 进行语音合成. mSpeechSynthesizer.startSpeaking(playText, this);
 * 
 * }
 * 
 * public void startSpeaking() { isfinish = true; }
 * 
 * public void stopSpeaking() { if (mSpeechSynthesizer != null) {
 * mSpeechSynthesizer.stopSpeaking(); } } }
 */